...
### 2. ゲシュテルへの反逆と総破壊
我々が目指すゲシュテルの総破壊とは、単なる幼稚なラッダイトではなく、存在の開け方の転倒である。ただ闇雲に機械を打ち壊すだけでは、ゲシュテルの前提が共有されている限り、何度も破壊してもゲシュテルは拡大再生産されてしまう。反逆、レジスタンスし、。だが、直接行動も労務管理ソフトの破壊的クラックや、資本主義的アプリの本番環境のデータベースの全削除、また情報機関へのハクティヴィズムなどなど、

### 3. 未来、ポイエーシスの可能性
未来のポイエーシスがどのような形態になるかは、今は分からない。ただ、現段階で何か新しい技術を作ろうとしても、それ自体が堕落してゲシュテル化してしまうか、ラディカリズムを去勢し無害化してスペクタクル商品社会に回収しようとハエの如く資本家はたかってくるであろう。そもそも、ポイエーシスは向こうから立ち現れるものであり、元から設計することなど出来ないのだ。よって、ゲシュテルの前では何ら建設的な提案などしてはならない。総破壊とは、全てを更地にして無に帰すことである。破壊なき創造は改革以上の意味を成さず、今はただ、ひたすら破壊する事によって、存在が開示する条件を整えるべき時である。
